...
//
// export const findValidMatches = <T>(
//   board: Board<T>,
//   position: Position,
//   matches: Match<T>[],
//   value: T
// ): Match<T>[] => {
//   if (
//     piece(board, { row: position.row + 1, col: position.col }) === value &&
//     piece(board, {
//       row: position.row - 1,
//       col: position.col,
//     }) === value
...
//   }
//   if (
//     piece(board, { row: position.row, col: position.col + 1 }) === value &&
//     piece(board, {
//       row: position.row,
//       col: position.col - 1,
//     }) === value
...
// };
//
// export const swapPieces = <T>(
//   board: Board<T>,
//   first: Position,
//   second: Position
// ): void => {
//   [board.pieces[first.row][first.col], board.pieces[second.row][second.col]] = [
//     board.pieces[second.row][second.col],
//     board.pieces[first.row][first.col],
//   ];
// };
//
// export const registerMatch = <T>(
//   matches: Match<T>[],
//   effects: Effect<T>[]
// ): Effect<T>[] => {
...
// };
//
// export const constructAllMatchesFromBoard = <T>(
//   board: Board<T>,
//   matches: Match<T>[]
// ): Match<T>[] => {
...
//             (position) => position.row === ir && position.col === ic
//           )
//         )
//       ) {
...
// };
//
// export const removeMatchesFromBoard = <T>(
//   board: Board<T>,
//   positions: Position[]
// ): void => {
//   board.pieces.forEach((row, ir) => {
//     row.forEach((_, ic) => {
//       if (
//         positions.some((position) => position.row === ir && position.col === ic)
//       ) {
...
//         ir < board.height - 1 &&
//         board.pieces[ir][ic] !== undefined &&
//         board.pieces[ir + 1][ic] === undefined
//       ) {
...
//
// //recursive function
// export const handleCascadeEffect = <T>(
//   generator: Generator<T>,
//   board: Board<T>,
//   effects: Effect<T>[]
// ): Effect<T>[] => {
...
//       board,
//       constructAllMatchesFromBoard(board, []).flatMap(
