// import { handleCascadeEffect, matchesExists, swapPieces } from "./utils";
//
...
//     width,
//     height,
//     pieces: [...new Array(height)].map((_) =>
//       [...new Array(width)].map((_) => generator.next())
//     ),
//   };
// }
//
...
//   if (
//     !matchesExists(board, first, board.pieces[first.row][first.col]) &&
//     !matchesExists(board, second, board.pieces[second.row][second.col])
//   ) {
//     swapPieces(board, first, second);
//     return false;
//   }
